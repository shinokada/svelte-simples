<script>
  ...
  export let ariaLabel = 'Sanfranciscomunicipalrailway';
</script>
...
<svg
  ...
  ><title>San Francisco Municipal Railway</title><path
...
@prop export let ariaLabel = 'Sanfranciscomunicipalrailway';
-->
